...
import com.crayon.youcanpass.component.JwtAuthenticationTokenFilter;
import com.crayon.youcanpass.component.RestAuthenticationEntryPoint;
import com.crayon.youcanpass.component.RestfulAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .permitAll()
                .antMatchers("/ums/user/login", "/ums/user/register")// 对登录注册要允许匿名访问
                .permitAll()
...
//                .permitAll()
    ...
    public UserDetailsService userDetailsService() {
        ...
        return username -> {
            ...
            if (user != null) {
                List<UmsPermission> permissionList = userService.listPermissionByUserId(user.getId(), LEAF, ENABLE);
